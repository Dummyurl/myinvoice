...
if (isset($url_segment) && in_array($url_segment, $userArr)) {
    ...
    $add_service_category_active = "active";
...
<nav class="navbar-default navbar-static-side " role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <li class="<?php echo $service_active . $service_category_active . $service_inquiry_active . $add_service_category_active; ?>">
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li class="<?php echo $service_category_active . $add_service_category_active; ?>"><a href="<?php echo base_url("service_category"); ?>"><i class="fa fa-server"></i><span class="nav-label">Service Category</span><span class="fa arrow"></span></a>

                        <ul class="nav nav-second-level">
                            <li class="<?php echo $service_category_active; ?>"><a href="<?php echo base_url("service_category"); ?>">Manage Category </a></li>
                            <li class="<?php echo $add_service_category_active; ?>"><a href="<?php echo base_url("insert_service_category"); ?>">Add  Category</a></li>
                        </ul> 
                    </li>
