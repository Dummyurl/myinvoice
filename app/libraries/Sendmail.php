...
class Sendmail {
    ...
    public function send($toparam = array(), $subject, $html_body, $attachment = NULL) {
        ...
        $logo_img = base_url() . img_path . "/logo.png";
        $fb_img = base_url() . img_path . "/mail/long_shadowv1_12.gif";
        $google_img = base_url() . img_path . "/mail/long_shadowv1_11.gif";
        $twitter_img = base_url() . img_path . "/mail/long_shadowv1_13.gif";
