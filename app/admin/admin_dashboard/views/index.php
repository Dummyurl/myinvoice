<?php
include APPPATH . '/modules/views/admin_top.php';
?>
<div class="row">
    <div class="col-xs-12">
        <div class="x_panel">                    
            <div class="x_content">            
                <div class="col-lg-4 dashboard-widget" style="margin-left: 10px">
                    ...
                    <div class="dashboard-widget-content">
                        ...
                        <a class="change_font btn btn-info pull-right"  href="<?php echo base_url("admin-user"); ?>">Manage User</a>
                    </div>
                </div>
                <div class="col-lg-4 dashboard-widget" style="margin-left: 10px">
                    <div class="dashboard-widget-title text-center" style="padding-left: 0;">
                    ...
                    <div class="dashboard-widget-content">
                        ...
                        <a class="change_font btn btn-info pull-right"  href="<?php echo base_url("admin-customer"); ?>">Manage Customer</a>
                    </div>
                </div>
            </div>
        </div>
