<?php include APPPATH . '/modules/views/admin_top.php';
?>
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <form id="profile_form" method="post" action="<?php echo $this->config->item("site_url") . "admin-profile-action" ?>" class="form-horizontal form-label-left input_mask" enctype="multipart/form-data">
                <div class="x_content">
                    <br />
...
<?php
include APPPATH . '/modules/views/admin_footer.php';
