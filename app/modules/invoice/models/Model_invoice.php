...
class Model_invoice extends CI_Model {
    ...
    function insert_mul($tbl = '', $data = array()) {
        if ($tbl == '') {
            $tbl = $this->main_table;
        }
    ...
    function getSingleData($tbl = '', $fields, $condition = '', $join_ary = array(), $orderby = '', $groupby = '', $having = '', $climit = '', $paging_array = array(), $reply_msgs = '', $like = array()) {
