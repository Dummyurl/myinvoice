...
<html lang="en">
    <head>
        ...
        <title><?php echo MY_SITE_NAME ?>| Forgot Password</title>
        ...
        <div id="wrapper">
            <div id="login" class="animate form">
                <section class="login_content">
                    <form method="POST" name="resetpass" id="resetpass" action="<?php echo $this->config->item("site_url") . 'root/forgot_password_action' ?>"  role="form">      
