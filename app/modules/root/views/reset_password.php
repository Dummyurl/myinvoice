...
<html lang="en">
	...
	<link rel="icon" href="<?php echo $this->config->item('images_url'); ?>favicon.png" type="image/x-icon" />
        <title><?php echo MY_SITE_NAME ?>| Reset Password</title>
        ...
        <div id="wrapper">
            <div id="login" class="animate form">
                <section class="login_content">
                    <form method="POST" name="resetpass" id="resetpass" action="<?php echo $this->config->item("site_url") . 'root/reset_user_action' ?>"  role="form">      
