...
<html>
    <head>
        ...
        <?php include APPPATH . '/modules/views/admin_common_files.php'; ?>    
        <script>
    ...
    <body class="nav-md">
        ...
        <div class="container body">
            <div class="main_container">
                <?php include APPPATH . '/modules/views/admin_side.php'; ?>  
                <div class="top_nav">
                    <div class="nav_menu">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="">
                                    ...
                                    <ul class="dropdown-menu dropdown-usermenu animated fadeInDown pull-right">
                                        <li><a href="<?php echo $this->config->item("site_url") . "admin-profile" ?>">  Profile</a>
                                        </li>                                        
                                        <li><a href="<?php echo $this->config->item("site_url") . "admin-logout" ?>"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                                        </li>
                                    </ul>
                                </li>
