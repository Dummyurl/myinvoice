<div class="col-md-3 left_col" style="min-height: 100%;background: #2A3F54;position: fixed" >
    ...
    <div class="left_col scroll-view">
        ...
        $userArr = array("admin-users");
        $customerArr = array("admin-customer");

        if (isset($url_segment) && $url_segment == "admin-dashboard") {
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu custom_bg">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    <li class="li_text <?php echo $Dashboard; ?>"><a href="<?php echo $this->config->item("site_url"); ?>admin-dashboard"><i class="fa fa-home"></i> Dashboard</a></li>
                    <li class="li_text <?php echo $user; ?>"><a href="<?php echo $this->config->item("site_url"); ?>admin-user"><i class="fa fa-user"></i> User</a></li>
                    <li class="li_text <?php echo $customer; ?>"><a href="<?php echo $this->config->item("site_url"); ?>admin-customer"><i class="fa fa-users"></i> Customer</a></li>
